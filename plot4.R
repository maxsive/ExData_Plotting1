plot4 <- function() {
      ...
      ##Set 2x2 Grid for the four plots
      par(mfcol=c(2,2))
      
      ##First plot (upper left) is a copy of Plot2 in the assignment
      with(hpc_data,plot(datetime,Global_active_power,type="l", ylab="Global Acive Power (kilowatts)",xlab=""))
      
      ##Second plot (lower left) is a copy of Plot3 in the assignment
      ...
      ##Third plot (upper right) is Voltage over time
      with(hpc_data,plot(datetime,Voltage,type="l", ylab="Voltage",xlab=""))
      
      ##Fourth plot (lower right) is Global Reactive Power over time
      with(hpc_data,plot(datetime,Global_reactive_power,type="l", ylab="Global Reacive Power (kilowatts)",xlab=""))
